(function($) {
	...
	// checks
	if( fsOptions.mtm_fs_wp_field_animation_type ) {
		fsAnimation = fsOptions.mtm_fs_wp_field_animation_type;
	}

	if( 'true' == fsOptions.mtm_fs_wp_field_slider_height || 'false' == fsOptions.mtm_fs_wp_field_slider_height ) {
		fsSmoothHeight = JSON.parse(fsOptions.mtm_fs_wp_field_slider_height);
	}

	if( 'true' == fsOptions.mtm_fs_wp_field_animation_autoplay || 'false' == fsOptions.mtm_fs_wp_field_animation_autoplay ) {
		fsSlideshow = JSON.parse(fsOptions.mtm_fs_wp_field_animation_autoplay);
	}

	if( fsOptions.mtm_fs_wp_field_animation_speed ) {
		fsSlideshowSpeed = fsOptions.mtm_fs_wp_field_animation_speed;
	}

	if( fsOptions.mtm_fs_wp_field_control_nav ) {
		fsControlNav = JSON.parse(fsOptions.mtm_fs_wp_field_control_nav);
	}

	if( fsOptions.mtm_fs_wp_field_direction_nav ) {
		fsDirectionNav = JSON.parse(fsOptions.mtm_fs_wp_field_direction_nav);
	}
