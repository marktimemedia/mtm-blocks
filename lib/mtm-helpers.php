...
if( !function_exists( 'mtm_page_component_meta_tax_title_query' ) ) {
  function mtm_page_component_meta_tax_title_query( $posttype = 'post', $perpage = 3, $term_field = false , $schedule_date = false, $orderby = 'title', $order = 'ASC', $notin = 'sticky_posts' ) {
    ...
    if( $term_field ) {
      $taxonomy = get_term(  $term_field )->taxonomy;
      $terms = get_term( $term_field )->slug;
