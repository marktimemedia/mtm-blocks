		...
		$config = array(
			...
			'strings'      => array(
				...
				/* translators: 1: plugin name(s). */
					'ACF Custom Blocks requires the following plugin: %1$s.',
					'ACF Custom Blocks requires the following plugins: %1$s.',
					'mtm'
				),
				'notice_can_install_recommended' => _n_noop(
					/* translators: 1: plugin name(s). */
					'ACF Custom Blocks recommends the following plugin: %1$s.',
					'ACF Custom Blocks recommends the following plugins: %1$s.',
					'mtm'
				), // %1$s = plugin name(s).
			),
