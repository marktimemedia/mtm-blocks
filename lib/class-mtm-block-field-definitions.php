	...
	public static function mtm_block_list_posts( $label = 'Post List' ) {
		return apply_filters( 'mtm_block_list_posts_filter', array(
			...
			'fields' => array(
				...
				array(
					'key' => 'field_9285urb295gf39456block',
					'label' => '',
					'name' => 'mtm_show_image',
					'type' => 'true_false',
					'instructions' => '',
				...
				array(
					'key' => 'field_938rheirfh9u456block',
					'label' => '',
					'name' => 'mtm_show_date',
					'type' => 'true_false',
					'instructions' => '',
				...
				array(
					'key' => 'field_57834534dfgh547block',
					'label' => '',
					'name' => 'mtm_show_excerpt',
					'type' => 'true_false',
					'instructions' => '',
					'required' => '',
					'conditional_logic' => '',
	...
	public static function mtm_block_grid_posts( $label = 'Post Grid' ) {
		return apply_filters( 'mtm_block_grid_posts_filter', array(
			...
			'fields' => array(
				...
				array(
					'key' => 'field_9285urb295gf398thfblock',
					'label' => '',
					'name' => 'mtm_show_image',
					'type' => 'true_false',
					'instructions' => '',
				...
				array(
					'key' => 'field_938rheirfh9u0447block',
					'label' => '',
					'name' => 'mtm_show_date',
					'type' => 'true_false',
					'instructions' => '',
				...
				array(
					'key' => 'field_57834534dfgh646block',
					'label' => '',
					'name' => 'mtm_show_excerpt',
					'type' => 'true_false',
					'instructions' => '',
