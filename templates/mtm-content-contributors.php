...
if( $users = _get_field( 'mtm_user_picker' ) ) : ?>
	<div class="mtm-module--content mtm-user-picker">
		...
		$authorlink = $userpost > 0 ? true : false ?>
			<div class="mtm-user-picker--user <?php echo $mtm_grid_row_class; ?>">
				...
				<h3><?php if( $authorlink ) { echo '<a href="' . esc_url( get_author_posts_url( $user['ID'] ) ) .'">'; } ?><?php echo esc_html( $user['display_name'] ); ?><?php if( $authorlink ) { echo '</a>'; } ?></h3>
