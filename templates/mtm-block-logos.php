	...
	if ( have_rows( 'mtm_logo_repeater' ) ) :
		...
		<div class="mtm-module--logos">
			...
			while ( have_rows( 'mtm_logo_repeater' ) ) :
				...
				?>
				<a class="mtm-logo-grid mtm-per-row-<?php echo esc_attr( $count ); ?> logo-<?php echo esc_attr( $j++ ); ?>" href="<?php esc_url( the_sub_field( 'mtm_content_link' )['url'] ); ?>"><img src="<?php echo esc_url( mtm_acf_sub_image_property( 'mtm_logo_image', 'url' ) ); ?>"></a>
			<?php endwhile; ?>
		</div>
