...
<?php if ( 'Pick From Taxonomy' === _get_field( 'mtm_list_archive_select' ) ) : // Taxonomy Source ?>
	<div class="mtm-module--grid">
		...
		$grid_taxonomy = mtm_acf_taxonomy_property( 'list', 'taxonomy' );
		$grid_term     = mtm_acf_taxonomy_property( 'list', 'slug' );
		...
		if ( _get_field( 'mtm_show_view_all_link' ) ) :
			?>
			<a aria-label="View All" class="mtm-view-all-link" href="<?php echo esc_url( get_term_link( $grid_term, $grid_taxonomy ) ); ?>"><?php echo esc_html( $viewtext ); ?></a>
		<?php endif; ?>
	</div>
...
<?php elseif ( 'Pick From Post Type' === _get_field( 'mtm_list_archive_select' ) ) : // Post Type Source ?>
	...
	<?php
elseif ( 'Add Posts Manually' === _get_field( 'mtm_list_archive_select' ) ) : // Post Type Source
	?>
	<div class="mtm-module--grid">
		<?php
		if ( _get_field( 'mtm_show_taxonomy_links' ) ) :
